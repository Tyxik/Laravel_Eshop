...
<div id="why-choose-us" class="py-16 text-center bg-gray-100 dark:bg-gray-800" data-aos="fade-up" data-aos-duration="1500">
    ...
    <div class="mt-10 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
        @foreach ([
            ['icon' => 'clock', 'title' => 'Rychlá Doprava', 'description' => 'Zaručujeme rychlé dodání vašich objednávek.'],
            ['icon' => 'check-circle', 'title' => 'Kvalitní Produkty', 'description' => 'Naše produkty procházejí důkladným výběrem kvality.'],
            ['icon' => 'support', 'title' => 'Zákaznická Podpora', 'description' => 'Jsme tu pro vás, abychom zodpověděli všechny vaše dotazy.']
        ] as $card)
        <div class="bg-white dark:bg-gray-700 shadow-lg rounded-xl p-6 group transition-transform duration-500 ease-in-out hover:scale-105 hover:shadow-2xl" data-aos="fade-up" data-aos-duration="1500">
            <div class="flex justify-center mb-4">
                <div class="relative">
                    <svg class="w-12 h-12 text-gray-800 dark:text-white" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        @if ($card['icon'] === 'clock')
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8v4l3 3M3.223 14C4.132 18.008 7.717 21 12 21c4.971 0 9-4.029 9-9 0-4.971-4.029-9-9-9-3.729 0-6.929 2.268-8.294 5.5M7 9H3V5" />
                        @elseif ($card['icon'] === 'check-circle')
                        <path fill-rule="evenodd" d="M2 12C2 6.477 6.477 2 12 2s10 4.477 10 10-4.477 10-10 10S2 17.523 2 12Zm11-4a1 1 0 1 0-2 0v4a1 1 0 0 0 .293.707l3 3a1 1 0 0 0 1.414-1.414L13 11.586V8Z" clip-rule="evenodd" />
                        @elseif ($card['icon'] === 'support')
            ...
            <h3 class="text-xl font-bold text-gray-900 dark:text-white mb-2 group-hover:underline group-hover:decoration-yellow-400 group-hover:decoration-[4px]">
                {{ $card['title'] }}
            </h3>
