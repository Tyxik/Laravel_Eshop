<div class="py-16">
    ...
    <form class="max-w-lg mx-auto mt-8 p-8 bg-white shadow-lg rounded-lg" action="https://formspree.io/f/mwplpavd" method="POST">
        ...
        <div class="mb-6">
            ...
            <input type="text" id="name" name="name" class="border border-gray-300 rounded-md w-full p-4 mt-2 focus:ring-yellow-300 focus:border-yellow-300" required>
        </div>
        <div class="mb-6">
            <label for="email" class="block text-sm font-medium text-gray-700">E-mail</label>
            <input type="email" id="email" name="email" class="border border-gray-300 rounded-md w-full p-4 mt-2 focus:ring-yellow-300 focus:border-yellow-300" required>
        </div>
        <div class="mb-6">
            <label for="message" class="block text-sm font-medium text-gray-700">Zpráva</label>
            <textarea id="message" name="message" class="border border-gray-300 rounded-md w-full p-4 mt-2 focus:ring-yellow-300 focus:border-yellow-300" required></textarea>
        </div>
